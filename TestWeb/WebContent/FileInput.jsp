...
<body >
    ...
    <p><span style="color:black">选择文件:</span>&nbsp;&nbsp;&nbsp;<input type="file" name="html" id="filesToUpload" multiple="" onChange="makeFileList();" style="background-color: green;"/>
    &nbsp;&nbsp;<input type="submit" name="grade" class="button yellow side" value="提交"></p>
    <span style="color:black">您选中的文件:</span>
    <span style="color:black"><ul id="fileList"><li>您没有选择文件</li></ul></span>
