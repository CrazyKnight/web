...
<html>
  ...
  <body>
     ...
     <form name="f1" id="f1" action="<%=path%>/add1" method="post">
      <table border="0" width="60%" >
        <tr>
 
          <h1><span style="color:Teal">请输入您要添加的成绩信息：</span></h1>
          <h3><span style="color:Red">${tipAdd }</span></h3>
	          <td>学期*</td>
          ...
          <tr>
	          <td>类别*</td>
	          <td><input type="text" name="newkind"></td>
          </tr>
   ...
   <form action="show1">
    <td colspan="2" align="center"><input type="submit" value="跳到显示界面"></td>
    </form>
  </body>
</html>