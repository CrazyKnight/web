...
public class zfbGet {
    public void get(File[] html) {
        try {
            ...
            stmt.execute("create table table3(" + "csmBNos varchar(50),"
                    + "times varchar(50)," + "infos varchar(50),"
                    + "incomes varchar(50)," + "outlays varchar(50),"
                    + "balances varchar(50)," + "froms varchar(50));");

            for (int k = 0; k < html.length; k++) {

                Document doc = Jsoup.parse(html[k], "GBK");
