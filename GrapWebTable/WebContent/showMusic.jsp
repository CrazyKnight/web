...
<div class="page">
	...
	<button type="button" class="button gray side"      onclick="window.location.href='FileInput.jsp?index=7'">上传</button>
	<button type="button" class="button gray round"     onclick="window.location.href='download7?tindex=7'">下载</button>
	<br>
