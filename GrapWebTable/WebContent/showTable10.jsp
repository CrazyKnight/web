...
<div class="page">
	...
	<button type="button" class="button gray side"      onclick="window.location.href='FileInput.jsp?index=10'">上传</button>
	<button type="button" class="button gray round"     onclick="window.location.href='download10?tindex=10'">下载</button>
	<br>
