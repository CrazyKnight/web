...
<div class="page">
	...
	<button type="button" class="button gray larrow"    onclick="window.location.href='welcome.jsp'">返回主菜单</button>
	<button type="button" class="button gray side"      onclick="window.location.href='FileInput.jsp?index=2'">上传</button>
	<button type="button" class="button gray round"     onclick="window.location.href='download2?tindex=2'">下载</button>
	<br>
    ...
    <table border="1" cellpadding="2" cellspacing="0">
        <tr>
            ...
            <s:if test="#field=='numItem'"> <td><center><s:property /></center></td></s:if>
            <s:else> <td><center>
		...
		<tr>
		<s:if test="#taobaoTbl.Multi!=null">
            <td width="100px"><center><c:property value="#taobaoTbl.Multi"/></center></td>
            </s:if>
