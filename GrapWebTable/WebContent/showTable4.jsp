...
<div class="page">
	...
	<button type="button" class="button gray side"      onclick="window.location.href='FileInput.jsp?index=4'">上传</button>
	<button type="button" class="button gray round"     onclick="window.location.href='download4?tindex=4'">下载</button>
	<br>
