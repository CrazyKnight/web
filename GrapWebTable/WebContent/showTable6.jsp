...
<div class="page">
	...
	<button type="button" class="button gray side"      onclick="window.location.href='FileInput.jsp?index=6'">上传</button>
	<button type="button" class="button gray round"     onclick="window.location.href='download6?tindex=6'">下载</button>
	<br>
