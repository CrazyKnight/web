...
<body >
	...
	<button type="button" class="button gray"   onclick="window.location.href='show1'">哈工大成绩单</button>
	<button type="button" class="button black"  onclick="window.location.href='show2'">淘宝支付记录</button>
	<button type="button" class="button red"    onclick="window.location.href='show3'">支付宝账单</button>
	<button type="button" class="button yellow" onclick="window.location.href='show4'">手机通讯录</button>
	<button type="button" class="button green"  onclick="window.location.href='show5'">豆瓣小组</button>
	<br>
	<br>
	<button type="button" class="button gray"   onclick="window.location.href='show6'">金属熔点表</button>
	<button type="button" class="button black"  onclick="window.location.href='show7'">歌曲排行榜</button>
	<button type="button" class="button red"    onclick="window.location.href='show8'">高考成绩分布</button>
	<button type="button" class="button yellow" onclick="window.location.href='show9'">电影列表</button>
	<button type="button" class="button green"  onclick="window.location.href='show10'">bt种子列表</button>
	<br>
	<br>
	<br>
	<br>
	...
	<br>
	<br>
	<button type="button" class="button black rarrow" onclick="window.location.href='aboutUs.jsp'">关于我们</button>
	</div>
	</section>
	</div>
</body>
